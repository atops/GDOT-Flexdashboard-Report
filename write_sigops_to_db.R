...
# Hack before we can update upstream packaging:
# cor$wk$aogd <- cor$wk$aog
# cor$wk$aog <- NULL
# cor$wk$qsd <- cor$wk$qs
# cor$wk$qs <- NULL
# 
# cor$mo$vphpa <- cor$mo$vphp$am
# cor$mo$vphpp <- cor$mo$vphp$pm
# cor$mo$vphp <- NULL
# cor$wk$vphpa <- cor$wk$vphp$am
# cor$wk$vphpp <- cor$wk$vphp$pm
# cor$wk$vphp <- NULL
# 
# sub$mo$vphpa <- sub$mo$vphp$am
# sub$mo$vphpp <- sub$mo$vphp$pm
# sub$mo$vphp <- NULL
# sub$wk$vphpa <- sub$wk$vphp$am
# sub$wk$vphpp <- sub$wk$vphp$pm
# sub$wk$vphp <- NULL
# 
# sig$mo$vphpa <- sig$mo$vphp$am
# sig$mo$vphpp <- sig$mo$vphp$pm
# sig$mo$vphp <- NULL
# sig$wk$vphpa <- sig$wk$vphp$am
# sig$wk$vphpp <- sig$wk$vphp$pm
# sig$wk$vphp <- NULL
