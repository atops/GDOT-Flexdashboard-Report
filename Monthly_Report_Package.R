...
tryCatch({
    ...
    batch_write_items(cor$qu$vpd %>% filter(!is.na(Quarter)), "cor-qu-vpd")
    batch_write_items(cor$qu$vphpa %>% filter(!is.na(Quarter)), "cor-qu-vphpa")
    batch_write_items(cor$qu$vphpp %>% filter(!is.na(Quarter)), "cor-qu-vphpp")
    batch_write_items(cor$qu$tp %>% filter(!is.na(Quarter)), "cor-qu-tp")
    batch_write_items(cor$qu$aogd %>% filter(!is.na(Quarter)), "cor-qu-aogd")
    batch_write_items(cor$qu$prd %>% filter(!is.na(Quarter)), "cor-qu-prd")
    batch_write_items(cor$qu$qsd %>% filter(!is.na(Quarter)), "cor-qu-qsd")
    batch_write_items(cor$qu$sfd %>% filter(!is.na(Quarter)), "cor-qu-sfd")
    batch_write_items(cor$qu$tti %>% filter(!is.na(Quarter)), "cor-qu-tti")
    batch_write_items(cor$qu$pti %>% filter(!is.na(Quarter)), "cor-qu-pti")
    batch_write_items(cor$qu$du %>% filter(!is.na(Quarter)), "cor-qu-du")
    batch_write_items(cor$qu$cu %>% filter(!is.na(Quarter)), "cor-qu-cu")
    batch_write_items(cor$qu$pau %>% filter(!is.na(Quarter)), "cor-qu-pau")
    batch_write_items(cor$qu$veh %>% filter(!is.na(Quarter)), "cor-qu-veh")
    batch_write_items(cor$qu$ped %>% filter(!is.na(Quarter)), "cor-qu-ped")
    batch_write_items(cor$qu$cctv %>% filter(!is.na(Quarter)), "cor-qu-cctv")
    batch_write_items(cor$qu$reported %>% filter(!is.na(Quarter)), "cor-qu-reported")
    batch_write_items(cor$qu$resolved %>% filter(!is.na(Quarter)), "cor-qu-resolved")
    batch_write_items(cor$qu$outstanding %>% filter(!is.na(Quarter)), "cor-qu-outstanding")
    #
    #
