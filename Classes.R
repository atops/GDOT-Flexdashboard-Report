...
vpd <- structure(
    metrics[["daily_traffic_volume"]],
    class = "metric"
)
am_peak_vph <- structure(
    metrics[["am_peak_hour_volume"]],
    class = "metric"
)
pm_peak_vph <- structure(
    metrics[["pm_peak_hour_volume"]],
    class = "metric"
)
...
aog <- arrivals_on_green <- structure(
    metrics[["arrivals_on_green"]],
    class = "metric"
)
progression_ratio <- structure(
    metrics[["progression_ratio"]],
    class = "metric"
)
queue_spillback_rate <- structure(
    metrics[["queue_spillback_rate"]],
    class = "metric"
)
peak_period_split_failures <- structure(
    metrics[["peak_period_split_failures"]],
    class = "metric"
)
off_peak_split_failures <- structure(
    metrics[["off_peak_split_failures"]],
    class = "metric"
)
travel_time_index <- structure(
    metrics[["travel_time_index"]],
    class = "metric"
)
planning_time_index <- structure(
    metrics[["planning_time_index"]],
    class = "metric"
)
...
daily_pedestrian_pushbuttons <- structure(
    metrics[["daily_pedestrian_pushbuttons"]],
    class = "metric"
)
detector_uptime <- structure(
    inherit(metrics[["uptime"]], metrics[["detector_uptime"]]),
    class = "metric"
)
ped_button_uptime <- structure(
    inherit(metrics[["uptime"]], metrics[["ped_button_uptime"]]),
    class = "metric"
)
cctv_uptime <- structure(
    inherit(metrics[["uptime"]], metrics[["cctv_uptime"]]),
    class = "metric"
)
comm_uptime <- structure(
    inherit(metrics[["uptime"]], metrics[["comm_uptime"]]),
    class = "metric"
)
rsu_uptime <- structure(
    inherit(metrics[["uptime"]], metrics[["rsu_uptime"]]),
    class = "metric"
)
tasks <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks"]]),
    class = "metric"
)
tasks_by_type <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_by_type"]]),
    class = "metric"
)
tasks_by_subtype <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_by_subtype"]]),
    class = "metric"
)
tasks_by_source <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_by_source"]]),
    class = "metric"
)
tasks_reported <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_reported"]]),
    class = "metric"
)
tasks_resolved <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_resolved"]]),
    class = "metric"
)
tasks_outstanding <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_outstanding"]]),
    class = "metric"
)
tasks_over45 <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_over45"]]),
    class = "metric"
)
tasks_mttr <- structure(
    inherit(metrics[["tasks_template"]], metrics[["tasks_mttr"]]),
    class = "metric"
)

maint_percent_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["maint_percent_health"]]),
    class = "metric"
)
maint_missing_data <- structure(
    inherit(metrics[["health_metrics"]], metrics[["maint_missing_data"]]),
    class = "metric"
)
du_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["du_score"]]),
    class = "metric"
)
pau_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["pau_score"]]),
    class = "metric"
)
cu_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["cu_score"]]),
    class = "metric"
)
cctv_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["cctv_score"]]),
    class = "metric"
)
flash_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["flash_score"]]),
    class = "metric"
)
du_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["du_health"]]),
    class = "metric"
)
pau_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["pau_health"]]),
    class = "metric"
)
cu_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["cu_health"]]),
    class = "metric"
)
cctv_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["cctv_health"]]),
    class = "metric"
)
flash_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["flash_health"]]),
    class = "metric"
)
...
ops_percent_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["ops_percent_health"]]),
    class = "metric"
)
pr_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["pr_score"]]),
    class = "metric"
)
pd_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["pd_score"]]),
    class = "metric"
)
sf_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["sf_score"]]),
    class = "metric"
)
tti_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["tti_score"]]),
    class = "metric"
)
bi_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["bi_score"]]),
    class = "metric"
)
pr_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["pr_health"]]),
    class = "metric"
)
pd_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["pd_health"]]),
    class = "metric"
)
sf_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["sf_health"]]),
    class = "metric"
)
tti_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["tti_health"]]),
    class = "metric"
)
bi_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["bi_health"]]),
    class = "metric"
)

safety_percent_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["safety_percent_health"]]),
    class = "metric"
)
safety_missing_data <- structure(
    inherit(metrics[["health_metrics"]], metrics[["safety_missing_data"]]),
    class = "metric"
)
bpsi_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["bpsi_score"]]),
    class = "metric"
)
rsi_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["rsi_score"]]),
    class = "metric"
)
cri_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["cri_score"]]),
    class = "metric"
)
kabco_score <- structure(
    inherit(metrics[["health_metrics"]], metrics[["kabco_score"]]),
    class = "metric"
)
bpsi_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["bpsi_health"]]),
    class = "metric"
)
rsi_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["rsi_health"]]),
    class = "metric"
)
cri_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["cri_health"]]),
    class = "metric"
)
kabco_health <- structure(
    inherit(metrics[["health_metrics"]], metrics[["kabco_health"]]),
    class = "metric"
)
...
get_descriptionBlock <- function(x, zone_group, month, quarter = NULL) {
    if (is.null(quarter)) { # want monthly, not quarterly data
        vals <- cor$mo[[x$table]] %>%
            dplyr::filter(Corridor == zone_group & Month == month) %>%
            as.list()
    } else {
        vals <- cor$qu[[x$table]] %>%
            dplyr::filter(Corridor == zone_group & Quarter == quarter) %>%
            as.list()
    }
    ...
    if (nrow(mdf) > 0 & nrow(wdf) > 0) {
        ...
        if (!is.null(metric$hourly_table)) {
            hdf <- query_data(
                metric,
                level,
                resolution = "monthly", hourly = TRUE,
...
travel_times_plot <- function(level, zone_group, month) {
    ...
    cor_monthly_tti <- query_data(
        travel_time_index,
        level = level, zone_group = zone_group, month = month, upto = TRUE
    )
    ...
    cor_monthly_tti_by_hr <- query_data(
        travel_time_index,
        level = level, zone_group = zone_group, month = month, hourly = TRUE, upto = FALSE
    )
    ...
    if (nrow(mott) > 0 & nrow(hrtt) > 0) {
        ...
        pbar <- plot_ly(sdb) %>%
            ...
            layout(
                barmode = "stack",
                xaxis = list(
                    title = glue("{format(month, '%b %Y')} TTI & PTI"),
                    zeroline = FALSE,
        ...
        pttimo <- plot_ly(sdm) %>%
            ...
            layout(
                xaxis = list(title = travel_time_index$label),
                yaxis = list(
                    range = c(mo_min, mo_max),
                    tickformat = tick_format
                ),
                showlegend = FALSE
            )
        ...
        pttihr <- plot_ly(sdh) %>%
            ...
            layout(
                xaxis = list(title = glue("{format(month, '%b %Y')} PTI by Hr")),
                yaxis = list(
                    range = c(hr_min, hr_max),
                    tickformat = tick_format
                ),
                showlegend = FALSE
            )
        ...
        pptimo <- plot_ly(sdm) %>%
            ...
            layout(
                xaxis = list(title = planning_time_index$label),
                yaxis = list(
                    range = c(mo_min, mo_max),
                    tickformat = tick_format
                ),
        ...
        subplot(pbar, stti, sbti, titleX = TRUE, widths = c(0.2, 0.4, 0.4), margin = 0.03) %>%
            layout(
                margin = list(l = 120, r = 80),
                title = "Travel Time and Planning Time Index"
            ) %>%
            highlight(
                color = travel_time_index$highlight_color,
                opacityDim = 0.9,
                defaultValues = c(zone_group),
                selected = attrs_selected(
                    insidetextfont = list(color = "white"),
...
uptime_multiplot <- function(metric, level, zone_group, month) {
    ...
    uptime_bar_plot <- function(df, month) {
        ...
        plot_ly(
            ...
            layout(
                barmode = "overlay",
                xaxis = list(
                    title = glue("{format(month, '%b %Y')} Uptime (%)"),
                    zeroline = FALSE,
                    tickformat = "%"
                ),
                yaxis = list(title = ""),
    ...
    avg_daily_uptime <- query_data(
        metric,
        level = level, resolution = "daily", zone_group = zone_group, month = month, upto = TRUE
    )
    avg_monthly_uptime <- query_data(
        metric,
        level = level, resolution = "monthly", zone_group = zone_group, month = month, upto = FALSE
    )
...
individual_cctvs_plot <- function(zone_group, month) {
    daily_cctv_df <- query_data(
        cctv_uptime,
        level = "signal", "daily", zone_group = zone_group, month = month
    )
