    ...
    renderUI({
        ...
        tags$div(
            ...
            p(span(class = "glyphicon glyphicon-arrow-up", style = "color: green"),
              "Green up arrow indicates an improvement from previous month ",
              "(where an increase in value represents an improvement); ",
              span(class = "glyphicon glyphicon-arrow-down", style = "color: green"),
              "green down arrow indicates an improvement from previous month ",
              "(where a decrease in value represents an improvement); ",
              span(class = "glyphicon glyphicon-arrow-down", style = "color: red"),
              "red up arrow indicates a deterioration from previous month ",
              "(where an increase in value represents a deterioration);",
              span(class = "glyphicon glyphicon-arrow-down", style = "color: red"),
              "red down arrow indicates a deterioration from previous month ",
              "(where a decrease in value represents a deterioration)."))
    })
)
```
