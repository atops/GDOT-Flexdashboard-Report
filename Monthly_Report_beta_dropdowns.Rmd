...
observe({
     ...
     # adding these makes sure the hideCols function is run upon change to lhs filters
    current_month(); input$zone_group; input$corridor_x
    ...
    maint_hide_cols <- setdiff(maintenance_cols$all, maintenance_cols_to_show)
...
output$maintenance_table <- renderDT({
    ...
    get_monthly_maintenance_health_table(
        ...
        # input$zone_group, input$corridor_x)  # zone_group(), corridor()
})
...
selectInput("maintenance_var", 
            label = "Maintenance Health Metric:",
            #choices = names(maintenance_sub)[7:19],
            choices = c("Percent Health", "Missing Data", "Detection Uptime Score", 
...
observe({
    ...
    # columns to hide = inverse (setdiff) of all columns and columns to show
    operations_hide_cols <- setdiff(operations_cols$all, operations_cols_to_show)
