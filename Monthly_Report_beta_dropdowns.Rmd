...
output$health_maint_plot <- renderPlotly({
    ...
    zone_group_ <- zone_group()
    current_month_ <- current_month()
    input$maintenance_var <- input_maintenance_var
...
```{r Safety, warning = FALSE, eval = FALSE}
...
```{r Safety Trend, warning = FALSE, eval = FALSE}

safety_metrics_list <- list(
    "Percent Health" = safety_percent_health,
    "Missing Data" = safety_missing_data,
    "Bike/Ped Safety Index Score" = bpsi_score,
    "Road Safety Index Score" = rsi_score,
    "Bike/Ped Safety Index" = bpsi_health,
    "Road Safety Index" = rsi_health
)
...
output$health_safety_plot <- renderPlotly({
    ...
    zone_group_ <- zone_group()
    current_month_ <- current_month()
    input$safety_var <- input_safety_var
