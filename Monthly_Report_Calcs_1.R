...
if (conf$run$travel_times == TRUE) {
    # Run python script asynchronously
    system("~/miniconda3/bin/conda run -n sigops python get_travel_times.py travel_times_1hr.yaml", wait = FALSE)
    system("~/miniconda3/bin/conda run -n sigops python get_travel_times.py travel_times_15min.yaml", wait = FALSE)
    system("~/miniconda3/bin/conda run -n sigops python get_travel_times_1min.py", wait = FALSE)
}
