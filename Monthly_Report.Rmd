...
current_month <- today() - days(6)
#current_month <- dmy(paste(1, selected_month))
first_month <- current_month - months(12)
month_options <- seq(current_month, first_month, by = "-1 month") %>% format("%B %Y")
...
### Pedestrian Detector Availability [automated--test] {.value-box}
...
### Pedestrian Detector Uptime [automated-test]
...
Zone 8:
[Dunwoody-Brookhaven](https://s3.amazonaws.com/gdot-devices/RTOP1/latest/Zone+8+-+Dunwoody-Brookhaven.pdf) | 
[Sandy Springs](https://s3.amazonaws.com/gdot-devices/RTOP1/latest/Zone+8+-+Sandy+Springs.pdf)
