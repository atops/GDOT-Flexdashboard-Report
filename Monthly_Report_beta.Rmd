...
renderPlotly({
    ...
    wk.data = m1dynq(mr_str(), "wk", "tp", first_month, endof_last_month) %>% 
        filter(Date <= endof_current_month())
    mo.data = m1dynq(mr_str(), "mo", "tp", current_month())
    dy.data = NULL
    
    get_bar_line_dashboard_plot(wk.data, mo.data, dy.data,
